...
#TODO Socket needs to send a status request message and data cache needs to respond with Data_cache.msg_counter
    """
...
if __name__ == "__main__":
    dc = Data_Cache('/var/run/Data_Cache.pid',stdout='/var/dc/dc_out.log', stderr='/var/dc/dc_err.err') #TODO may want to change this
    if len(sys.argv) == 2:
        if 'start' == sys.argv[1]:
            print 'starting.'
            dc.start()
